...
public class yonoMainController {
	...
	@GetMapping("/getyonobranches")
	    public List<branch> getallBranches(){
	        System.out.println(branchrepo.findAll());
	        return  branchrepo.findAll();
	    }
	@GetMapping("/getunamepass")
	public List<LoginCred> getcredentials(){
		System.out.println(logincredrepo.findAll());
...
//	public List<Object> getactiveuserdetails(@PathVariable long id)
//	{
//		return accountrepo.getuserdetails(id);
//	}
...
//		creditapplyRepo.save(creditapply);
			...
			creditapplyRepo.save(creditapply);
		//Integer countacnum = creditapplyRepo.getCountacnum(acnum);
		//System.out.println(countacnum);	
	}
	...
	@GetMapping("getbranch/{bid}")
	public Optional<branch> getbranch(@PathVariable Integer bid){
		return branchrepo.getBranch(bid);
	}
